...
export default function Home() {
  ...
  const getDAOContractInstance = async (providerOrSinger) =>
    new Contract(CRYPTODEVS_DAO_CONTRACT_ADDRESS, CRYPTODEVS_DAO_ABI, providerOrSinger);

  // helper function to return a CryptoDevs NFT contract instance
  const getCryptoDevsNFTContractInstance = async (providerOrSinger) =>
    new Contract(CRYPTODEVS_NFT_CONTRACT_ADDRESS, CRYPTODEVS_NFT_ABI, providerOrSinger);
  ...
  // reads the balance of the users cryptodevs nfts
